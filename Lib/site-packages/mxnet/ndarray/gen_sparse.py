...
def _contrib_round_ste(data=None, out=None, name=None, **kwargs):
    ...
    Defined in C:\Jenkins\workspace\mxnet-tag\mxnet\src\operator\contrib\stes_op.cc:L55
...
def _contrib_sign_ste(data=None, out=None, name=None, **kwargs):
    ...
    Defined in C:\Jenkins\workspace\mxnet-tag\mxnet\src\operator\contrib\stes_op.cc:L80
...
def adagrad_update(weight=None, grad=None, history=None, lr=_Null, epsilon=_Null, wd=_Null, rescale_grad=_Null, clip_gradient=_Null, out=None, name=None, **kwargs):
    ...
    Defined in C:\Jenkins\workspace\mxnet-tag\mxnet\src\operator\optimizer_op.cc:L909
